...
public class DragFloatActionWindow extends LinearLayout {
    ...
    public DragFloatActionWindow(Context context, WindowManager manager, WindowManager.LayoutParams params) {
        super(context);
    ...
    public DragFloatActionWindow(Context context, AttributeSet attrs) {
        super(context, attrs);

    }

    public DragFloatActionWindow(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                setY(y);
                ...
                Log.e(TAG, x+" x onTouchEvent:ACTION_MOVEy=== "+y );
    ...
    private void animateTo(int beginValue ,int endValue){
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                mWindowManager.updateViewLayout(DragFloatActionWindow.this, mLayoutParams);
            }
        });
        animator.start();
    }
